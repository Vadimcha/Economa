        ...
        sections: [
            ...
            },
            {
                ...
                content: <Text>
                    ...
                    <Space h={"sm"} />
                    Таким образом, если i - номер года, то выплата i-ый год будет равна:
                    <Space h={"sm"} />
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                content: <Text>Теория потребительского поведения изучает совокупность взаимосвязей, закономерностей в соответствии с которыми люди формируют план потребления различных товаров и  услуг.
                 <Space h={"sm"} />


                Ориентируясь на наиболее полное удовлетворение своих потребностей, теория потребителя занимается проблемой потребителей, закономерностями и мотивами их выбора. В теории потребления различают наличие ценности и цены. Иногда цена не соответствует пользе товара или услуге. А. Смит сформировал парадокс ценностей. Решение этого парадокса связано с введением предельных величин. Предельная величина характеризует прирост данной переменной при изменении объема потребления и производства. Количественный подход к анализу полезности основан на возможности измерения различных благ.
                <Space h={"sm"} />
               
                <b><i>Полезность</i></b> – это степень удовлетворения потребности индивидуума, которую они получают при потреблении товара или услуге, либо введении какой – либо деятельности (измеряется в ютилях).</Text> ,
            },
            {
                title: "Теория фирмы",
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                content: <Text fw={100}>
                     <i><b>Финансовый риск</b></i> — это возможность потерять деньги в связи с наступлением каких-либо предвиденных или непредвиденных обстоятельств.
                     <Space h={"sm"} />
                     Выделяют несколько основных методов оценки финансового риска:
                     <Space h={"sm"} />
                     <ul>
                        <li>1. <i><b>Статистический</b></i> — метод оценки риска, основанный на большом объёме информации об изменении цен на объекты инвестиций (ценные бумаги, валюту, драгоценные металлы и т. п.). Недостаток метода — отсутствие достаточного объёма информации для оценки. </li>
                        <li>2. <i><b>Экспертный</b></i> — отбор профессиональных оценок состояния рынка и прогнозов об изменении цен на объекты инвестиций (ценные бумаги, валюту, драгоценные металлы и т. п.). Недостаток метода — субъективность экспертных оценок.</li>
                        <li>3. <i><b>Метод аналогов</b></i> — сопоставление изменения цен на аналогичные объекты инвестиций (ценные бумаги, валюту, драгоценные металлы и т. п.). Недостаток метода — часто абсолютная аналогия отсутствует.</li>
                        <li>4. <i><b>Метод аналогов</b></i> — количественная оценка риска как отношения суммы возможного убытка к ожидаемому доходу. </li>
                        
                    </ul>
                    <Space h={"sm"} />
                    Если коэффицииент инвестиционного рынка меньше 5%, то риск считается приемлемым, если коэффицииент инвестиционного рынка 5-10%, то риск считается средним, если 10-20%, то риск считается высоким, если коэффицииент инвестиционного риска более 20%, то риск считается очень высоким
                </Text> ,
            },
            {
                title: "Кредитование",
